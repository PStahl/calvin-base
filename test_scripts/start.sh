...
csruntime --host localhost --port $1 --controlport $2 --keep-alive -l 'calvin.runtime.north.lost_node_handler:DEBUG' -l 'calvin.runtime.north.replicator:DEBUG' # -l 'calvin.runtime.north.portmanager:DEBUG' -l 'calvin.runtime.north.calvin_network:DEBUG'
